...
- retrieving repository and document memory
...
without coupling the platform to a specific AI provider and without forcing users to move their content into a platform-owned source-of-truth store.

---

# 3. Core Design Clarification
...
- rMEMbr indexes **locations, metadata, and retrieval signals**
- rMEMbr retrieves content on demand from those systems
- rMEMbr adds governance, standards, and scoped context around the retrieved content
- cached copies may exist for performance, but those copies are not the authoritative source

Examples of source systems include:
...
- Wikis
- file shares
- future enterprise content systems

This is a **federated retrieval model**, not a central repository model.

---

# 4. Model and Embedding Strategy
...
# 8. Azure Service Responsibilities
...
# 14. Infrastructure as Code Requirement
